...
Before handoff, audit space allocation. The goal is not to pack every pixel,
but to prevent dead bands and unreadable supporting visuals.
...
Common page archetypes each have **2–3 layout variants** (A / B / C). Pick the
variant the data calls for — do NOT default to variant A out of habit:
- Executive summary — A. Hero-Right · B. KPI-Strip · C. Headline-Hero
- Analytical canvas — A. Filter-Rail · B. Inline-Slicers · C. Small-Multiples-Grid
- Operational monitor — A. 4-Up Status · B. Wallboard · C. Incident-First
- Narrative story — A. 7/5 Split · B. Single-Column-Scroll · C. Annotated-Hero
- Comparative benchmark — A. Side-by-Side · B. Stacked-Pairs · C. Slope-Graph-First
